...
@Component({
  ...
  <app-fornecedores-lista [fornecedores]="dataSource" [displayedColumns]="displayedColumns"
...
export class FornecedoresComponent implements OnInit{
  ...
  onDeleteClick(event: Fornecedor){
    ...
    dialogConfig.data = { message: `Deseja realmente remover o fornecedor`, item: `${event.nome}` }
