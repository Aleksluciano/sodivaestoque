...
@Component({
  ...
  <app-clientes-lista [clientes]="dataSource" [displayedColumns]="displayedColumns"
...
export class ClientesComponent implements OnInit{
  ...
  displayedColumns: string[] = ['Indice','Nome', 'Endereço', 'Bairro', 'Cidade', 'Estado', 'Telefone', 'Celular','Email', 'Cpf','Rg','Ações'];
  clientes: Cliente[] = [];
  ...
  onDeleteClick(event: Cliente){
    ...
    dialogConfig.data = { message: `Deseja realmente remover o cliente`, item: `${event.nome}` }
